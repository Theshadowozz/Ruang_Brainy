...
<body class="bg-white font-sans text-gray-950">
    ...
    <main class="mx-auto max-w-7xl px-6 py-10 sm:px-10 lg:px-28">
        <p class="text-sm font-semibold uppercase tracking-normal text-blue-600">Dashboard Siswa</p>
        <h1 class="mt-2 text-3xl font-bold">Halo, {{ auth()->user()->name }}</h1>
        <p class="mt-3 max-w-2xl text-gray-600">Anda login sebagai siswa. Halaman ini hanya bisa dibuka oleh akun dengan role siswa.</p>
    </main>
</body>
</html>
